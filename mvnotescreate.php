...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        header("location: /mvinfo.php?carID=$carID&orderID=$orderID");
        exit;
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <?php echo "<a class='btn btn-outline-primary' href='/mvinfo.php?carID=$carID&orderID=$orderID' role='button'>Cancel</a>" ?>
                </div>
            </div>
